    ...
    describe("Teste de funcionalidades de um contato", () => {
        ...
        cy.get("input").eq(0).type("Marcus Gambogi");
        cy.get("input").eq(1).type("Marcus@teste.com");
        ...
        cy.get('[type="text"]').clear().type("Larissa Gambogi");
        cy.get('[type="email"]').clear().type("Larissa@teste.com");
